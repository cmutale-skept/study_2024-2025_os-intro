...
![Рис 6: файлы в домашнем каталоге начинающихся с "с"](image/6.PNG){#fig:006 width=70%}

Также можно это действие выполнить используя ls -lR | grep "c*"

![Рис 7: поиск файла используя grep](image/7.PNG){#fig:007 width=70%}

с помощью find /etc -name "h*" -print, вывожу файлы из каталога /etc, начинающиеся с символа h:

![Рис 8: файлы в etc начинающихся с "h"](image/8.PNG){#fig:008 width=70%}

В фоновом режиме запускаю процесс, который будет записывать в файл ~/logfile файлы, имена которых начинаются с log:

![Рис 9: Создание фонового режима](image/9.PNG){#fig:009 width=70%}

Удаляю созданный logfile и проверяю:

![Рис 10: удаление logfile](image/10.PNG){#fig:0010 width=70%}

Запускаю из консоли в фоновом режиме редактор gedit указывая &:

![Рис 11: запуск gedit в фоновом режиме](image/11.PNG){#fig:0011 width=70%}

Используя команду ps, конвейер и фильтр grep, определяю идентификатор процесса gedit (3576):

![Рис 12: идентификатор процесса gedit](image/12.PNG){#fig:0013 width=70%}

![Рис 13: Другой способ нахождение идентификатора процесса](image/13.PNG){#fig:0014 width=70%}

С помощью man прочитала справку команды kill и использую её для завершения процесса gedit:

![Рис 14: завершения процесса gedit](image/14.PNG){#fig:0015 width=70%}

С помощью man прочитала справку команд df и du:

![Рис 15: справка команды df](image/15.PNG){#fig:0016 width=70%}

![Рис 16: справка команды du](image/16.PNG){#fig:0017 width=70%}

Используя df -vi я вывожу информацию об инодах и вижу сколько свободного места у моей системы:

![Рис 17: df -vi](image/17.PNG){#fig:0018 width=70%}

Используя du -a вижу сколько места занимают файлы в директории Загрузки:

![Рис 18: du -a ](image/18.PNG){#fig:0019 width=70%}

Воспользовавшись справкой команды find и аргумент d, вывожу всех директорий, имеющихся в домашнем каталоге:

![Рис 19: Поиск директорий](image/19.PNG){#fig:0020 width=70%}

![Рис 20: результаты find ~ -type d](image/20.PNG){#fig:0021 width=70%}
