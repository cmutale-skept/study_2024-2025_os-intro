...
![Рис 1: Код для анализирования командной строки](image/1.PNG){#fig:001 width=70%}
...
![Рис 2: право на исполнение](image/2.PNG){#fig:002 width=70%}

![Рис 3: Запуск file1](image/3.PNG){#fig:003 width=70%}
...
![Рис 4: Программа на языке Си](image/4.PNG){#fig:004 width=70%}
...
![Рис 5: Командный файл программы на Си](image/5.PNG){#fig:005 width=70%}
...
![Рис 6: Результаты программы](image/6.PNG){#fig:006 width=70%}
...
![Рис 7: Командный файл для создания файлов](image/7.PNG){#fig:007 width=70%}
...
![Рис 8: Создание файлов с помощью командного файла](image/8.PNG){#fig:008 width=70%}
...
![Рис 9: Создание архива](image/9.PNG){#fig:009 width=70%}
...
![Рис 10: Результаты кода](image/10.PNG){#fig:0010 width=70%}
