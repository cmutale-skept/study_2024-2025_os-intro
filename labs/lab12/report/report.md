...
![Рис 1: Создание project.sh ](image/1.PNG){#fig:001 width=70%}

```
tar -cvf ~/backup/project.tar project.sh
```

![Рис 2: Скрипт](image/2.PNG){#fig:002 width=70%}

![Рис 3: Создание исполняемого файла](image/3.PNG){#fig:003 width=70%}

![Рис 4: Запуск файла](image/4.PNG){#fig:004 width=70%}

Я проверила с помощью cat,что копия содержит скрипт из оригинала:

![Рис 5: Проверка копии файла](image/5.PNG){#fig:005 width=70%}
...
![Рис 6: Создание project1.sh](image/6.PNG){#fig:006 width=70%}

![Рис 7: Код project1.sh](image/7.PNG){#fig:007 width=70%}
...
![Рис 8: Запуск project1.sh](image/8.PNG){#fig:008 width=70%}
...
![Рис 9: Создание project2.sh](image/9.PNG){#fig:009 width=70%}
...
![Рис 10: Программа project2.sh](image/10.PNG){#fig:0010 width=70%}

![Рис 11: Запуск программы](image/11.PNG){#fig:0011 width=70%}
...
![Рис 12: Код project3.sh](image/12.PNG){#fig:0013 width=70%}
...
![Рис 13: Запуск project3.sh](image/13.PNG){#fig:0012 width=70%}
