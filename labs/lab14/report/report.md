...
![Рис 1: упрощённый механизм семафоров (код)](image/1.PNG){#fig:001 width=70%}
...
![Рис 2: результаты кода](image/2.PNG){#fig:002 width=70%}
...
![Рис 3: ls /usr/share/man/man1](image/3.PNG){#fig:003 width=70%}
...
![Рис 4: командный файл man](image/4.PNG){#fig:004 width=70%}
...
![Рис 5: проверка командного файла man](image/5.PNG){#fig:005 width=70%}

![Рис 6: проверка командного файла man](image/6.PNG){#fig:006 width=70%}
...
![Рис 7: командный файл, генерирующий случайную последовательность букв](image/7.PNG){#fig:007 width=70%}

```
echo $RANDOM | tr '0-9' 'a-zA-Z'
```

![Рис 8: запуск скрипта](image/8.PNG){#fig:008 width=70%}
