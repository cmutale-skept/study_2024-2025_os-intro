...
![Рис 1: Информация о mc](image/1.PNG){#fig:001 width=70%}

Я запускала mc, изучала его структуру и меню:

![Рис 2: Командная оболочка mc](image/2.PNG){#fig:002 width=70%}

 Используя управляющие клавиши я; скопировала файл README.md в домашний каталог:

![Рис 3: Копирование файла](image/3.PNG){#fig:003 width=70%}

Создала файл new в ~/work/blog и удалила его: 

![Рис 4: Созданный файл](image/4.PNG){#fig:004 width=70%}

![Рис 5: Удаление файла](image/5.PNG){#fig:005 width=70%}

Получила информацию о размере и правах доступа на файл README.md:

![Рис 6: Информация о README.md](image/6.PNG){#fig:006 width=70%}

В правой панели вывела информацию о файле. При этом я получаю больше информации чем в выводе ls:

![Рис 7: Информфцию о файле](image/7.PNG){#fig:007 width=70%}

Используя возможности подменю Файл; я посмотрела содержаемые текстового файла:

![Рис 8: Содержаемые файла](image/8.PNG){#fig:008 width=70%}
...
![Рис 10: создание каталога](image/10.PNG){#fig:0010 width=70%}

и скопировала файл в ,только что созданный каталог:

![Рис 11: копирование файла](image/11.PNG){#fig:0011 width=70%}

С помощью подменю команда можно найти в файловой системе файл с заданными условиями:

![Рис 12: файлы которые содержат gz](image/12.PNG){#fig:0012 width=70%}

![Рис 13: результаты поиска](image/13.PNG){#fig:0013 width=70%}

Исользуя подменю команда я повторила одну из предыдущих команд:

![Рис 14: повторение команды](image/14.PNG){#fig:0014 width=70%}

Также перешла в домашний каталог и анализировала файл меню и файл расширения:

![Рис 15: Переход в домашний каталог](image/15.PNG){#fig:0015 width=70%}

![Рис 16: файл расширения](image/16.PNG){#fig:0016 width=70%}

Из подменю настройка вызвала окна настройки панели:

![Рис 17: Настройка панели](image/17.PNG){#fig:0017 width=70%}

Настройки внешнего вида:

![Рис 18: Настройки внешнего вида](image/18.PNG){#fig:0018 width=70%}

# Задание по встроенному редактору mc

С помощью команды touch создала text.txt:

![Рис 19: Создание text.txt](image/19.PNG){#fig:0019 width=70%}

Далее открыла его для редактирования с помощью f4 и с shift ctrl ins вставила текст:

![Рис 20: Редактирование text.txt](image/20.PNG){#fig:0020 width=70%}

С помощью f3 выделила текст и удалила выделеные слова f8:

![Рис 21: Удаление текста](image/21.PNG){#fig:0021 width=70%}

Перемещала выделенный текст с помощью f6:

![Рис 22: Перемещение текста](image/22.PNG){#fig:0022 width=70%}

Сохранила изменении с помощью f2:

![Рис 23: Сохранение изменений в файле](image/23.PNG){#fig:0023 width=70%}

С помощью ctrl-u отменила последнее действие:

![Рис 24: Отменение последнего действия](image/24.PNG){#fig:0024 width=70%}

Используя pg up и pg dn перешла в начало и конец файла и написала некоторый текст. Затем сохранила и закрыла файл:

![Рис 25: Добавление текста](image/25.PNG){#fig:0025 width=70%}

Открыла файл с исходным текстом на cpp:

![Рис 26: файл cpp](image/26.PNG){#fig:0026 width=70%}

Используя подменю команда я выключила подсветку синтаксиса:

![Рис 27: Подменю команда](image/27.PNG){#fig:0027 width=70%}

![Рис 28: подсветка синтаксиса](image/28.PNG){#fig:0028 width=70%}
